...
// Method 1: complete_lifecycle logic
...
const leads1 = rawConsolidatedLeads.filter(l => l.items && l.items.length > 0);
console.log('Method 1 (complete_lifecycle): Total leads =', leads1.length, 'total items =', leads1.reduce((sum, l) => sum + l.items.length, 0));
