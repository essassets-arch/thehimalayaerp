...
const csvPath = 'd:/prototype-next-main/backend/scripts/ravi_thakor_sales3.csv';
...
fs.writeFileSync('d:/prototype-next-main/backend/scripts/sales3_leads_data.json', JSON.stringify(orders, null, 2), 'utf8');
console.log('Saved to backend/scripts/sales3_leads_data.json');
