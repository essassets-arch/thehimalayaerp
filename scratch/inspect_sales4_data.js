...
async function testParse() {
  const content = fs.readFileSync('Gulshan_data(sales4).csv', 'utf8').replace(/^\uFEFF/, '');
  ...
  fs.writeFileSync('backend/scripts/sales4_leads_data.json', JSON.stringify(grouped, null, 2));
  console.log('Saved to backend/scripts/sales4_leads_data.json');
