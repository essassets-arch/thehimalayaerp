...
export class PermissionsGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (normalizedRole === 'SUPER_SALES' || normalizedRole.includes('SUPER_SALES') || normalizedRole.includes('SUPERSALES')) {
      [
        'sales.orders.read', 'sales.orders.create', 'sales.orders.update', 'sales.orders.approve', 'sales.orders.cancel',
        ...
        'sales.quotations.read', 'sales.quotations.create', 'sales.quotations.update', 'crm.quotations.read', 'crm.quotations.create', 'crm.quotations.update', 'crm.quotations.send', 'crm.quotations.convert', 'crm.quotations.accept',
        'sales.targets.read', 'sales.targets.create', 'sales.targets.update',
    ...
    if (normalizedRole === 'SALES_EXECUTIVE' || normalizedRole.includes('SALES')) {
      [
        ...
        'sales.customers.read', 'sales.customers.create', 'sales.customers.update', 'crm.customers.read',
        'sales.quotations.read', 'sales.quotations.create', 'sales.quotations.update', 'crm.quotations.read', 'crm.quotations.create', 'crm.quotations.update', 'crm.quotations.send', 'crm.quotations.convert', 'crm.quotations.accept',
        'sales.targets.read', 'sales.salesreports.read', 'sales.reports.read',
        'admin.samples.read', 'admin.samples.create', 'admin.samples.update', 'samples.read', 'samples.create', 'samples.update', 'sales.samples.read', 'sales.samples.create',
        'admin.salesreturns.read', 'admin.salesreturns.create', 'admin.salesreturns.update', 'sales.salesreturns.read', 'sales.salesreturns.create', 'sales.salesreturns.update', 'sales.returns.read', 'sales.returns.create', 'sales-returns.read', 'sales.returns.manage',
        'sales.customercomplaints.read', 'sales.customercomplaints.create', 'sales.complaints.read', 'sales.complaints.create',
        'admin.replacements.read', 'admin.replacements.create',
        'finance.payment.read', 'finance.payments.read', 'finance.payment.create',
        'logistics.dispatches.read', 'dispatch.shipments.read', 'inventory.stock.read', 'inventory.inventory.read', 'procurement.suppliers.read', 'suppliers.read', 'user.read',
      ].forEach(p => userPermSet.add(p));
    }
    ...
    if (normalizedRole === 'PLANT_HEAD' || normalizedRole.includes('PLANT_HEAD')) {
      [
        ...
        'materialrequests.read', 'materialrequests.create', 'materialrequests.approve', 'materialrequests.reject', 'store.materialrequests.read',
    ...
    if (normalizedRole === 'PRODUCTION' || normalizedRole.includes('PRODUCTION') || normalizedRole === 'PRODUCTION_MANAGER' || normalizedRole === 'PRODUCTION_PLANNER' || normalizedRole === 'PRODUCTION_SUPERVISOR') {
      [
        ...
        'production.productionworkflow.read', 'production.productionworkflow.create', 'production.finishedgoods.read', 'production.qc.read', 'qc.inspections.read',
        'admin.materialrequests.read', 'admin.materialrequests.create', 'admin.materialrequests.update', 'materialrequests.read', 'materialrequests.create',
    ...
    if (normalizedRole === 'DISPATCH_EXECUTIVE' || normalizedRole.includes('DISPATCH') || normalizedRole === 'LOGISTICS' || normalizedRole === 'DISPATCH_2' || normalizedRole === 'DISPATCH_MANAGER') {
      [
        ...
        'production.finishedgoods.read', 'production.workorder.read', 'production.workorders.read', 'user.read',
      ].forEach(p => userPermSet.add(p));
    }

    if (normalizedRole === 'STORE_MANAGER' || normalizedRole.includes('STORE') || normalizedRole === 'STORE_EXECUTIVE' || normalizedRole === 'STORE_KEEPER') {
      [
    ...
    if (normalizedRole === 'QC' || normalizedRole.includes('QC') || normalizedRole === 'QC_MANAGER' || normalizedRole === 'QC_INSPECTOR' || normalizedRole === 'QC_ENGINEER') {
      [
        'qc.inspections.read', 'qc.inspections.create', 'qc.inspections.update', 'qc.inspections.approve', 'qc.inspections.reject',
        'qc.inspection.read', 'qc.inspection.approve', 'qc.inspection.reject',
        'production.qc.read', 'production.qc.approve', 'production.qc.reject',
        'production.workorder.read', 'production.workorders.read', 'production.floor.read', 'production.finishedgoods.read',
        'inventory.stock.read', 'admin.products.read', 'products.read', 'user.read',
      ].forEach(p => userPermSet.add(p));
    }
    ...
    const PERMISSION_ALIASES: Record<string, string[]> = {
      ...
      'warehouses.read': ['inventory.warehouses.read', 'warehouses.read', 'inventory.stock.read', 'store.read', 'finance.read', 'admin.read', 'super-admin.read', 'production.productionworkflow.read', 'production.workorder.read', 'production.work_orders.manage', 'admin.planthead.read', 'planthead.read', 'plant-head.read'],
      'procurement.suppliers.read': ['procurement.suppliers.read', 'suppliers.read', 'vendors.read', 'store.read', 'finance.read', 'sales.read', 'sales.orders.read', 'sales.leads.read', 'user.read', 'admin.read', 'super-admin.read', 'production.productionworkflow.read', 'production.workorder.read', 'production.work_orders.manage', 'production.plan.read', 'production.floor.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read'],
      ...
      'production.finishedgoods.read': ['production.productionworkflow.read', 'production.finishedgoods.read', 'production.qc.read', 'qc.inspection.read', 'production.plan.read', 'production.plans.read', 'production.workorder.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read'],
      'production.plan.read': ['production.plan.read', 'production.plans.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'production.productionworkflow.read', 'production.floor.read', 'production.workorder.read', 'production.work_orders.manage'],
      'production.plans.read': ['production.plan.read', 'production.plans.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'production.productionworkflow.read', 'production.floor.read', 'production.workorder.read', 'production.work_orders.manage'],
      ...
      'production.workorder.start': ['production.workorder.start', 'production.work_orders.manage', 'production.workorder.manage', 'production.floor.start', 'production.productionworkflow.read', 'production.plan.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'sales.orders.update'],
      'production.workorder.complete': ['production.workorder.complete', 'production.work_orders.manage', 'production.workorder.manage', 'production.floor.complete', 'production.productionworkflow.read', 'production.plan.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'sales.orders.update'],
      'production.workorder.update': ['production.workorder.update', 'production.work_orders.manage', 'production.workorder.manage', 'production.floor.update', 'production.productionworkflow.read', 'production.plan.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'sales.orders.update'],
      ...
      'finance.read': ['finance.read', 'finance.brand-analysis.read', 'finance.payment.read', 'finance.invoices.read', 'finance.ledger.read', 'finance.payments.manage', 'finance.sales-analytics.read', 'finance.salary.manage', 'finance.salary.view', 'finance.reports.read', 'admin.read', 'super-admin.read'],
      'finance.reports.read': ['finance.reports.read', 'finance.read', 'finance.sales-analytics.read', 'admin.read', 'super-admin.read'],
      ...
      'sales.orders.update': ['sales.orders.update', 'sales.order.update', 'sales.orders.approve', 'sales.orders.create', 'production.work_orders.manage', 'production.workorder.manage', 'production.workorder.start', 'production.workorder.complete', 'production.workorder.read', 'production.productionworkflow.read', 'production.plan.read', 'production.floor.update', 'planthead.read', 'admin.planthead.read', 'plant-head.read'],
      ...
      'procurement.indents.create': ['procurement.indents.create', 'procurement.indents.update', 'procurement.procurement.create', 'procurement.procurement.read', 'store.materialrequests.create', 'store.create', 'store.read', 'admin.planthead.create', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'admin.read', 'super-admin.read'],
      'procurement.indents.update': ['procurement.indents.update', 'procurement.indents.approve', 'procurement.indents.reject', 'procurement.indents.create', 'procurement.indents.manage', 'procurement.procurement.read', 'admin.planthead.create', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'store.read', 'finance.read', 'admin.read', 'super-admin.read'],
      'procurement.indents.approve': ['procurement.indents.approve', 'procurement.indents.update', 'admin.planthead.create', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'admin.read', 'super-admin.read'],
      'procurement.indents.reject': ['procurement.indents.reject', 'procurement.indents.update', 'admin.planthead.create', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'admin.read', 'super-admin.read'],
      ...
      'procurement.purchase_orders.create': ['procurement.purchase_orders.create', 'procurement.purchase-orders.create', 'procurement.po.create', 'procurement.purchase_orders.update', 'finance.invoices.create', 'finance.read', 'admin.read', 'super-admin.read'],
      'procurement.purchase_orders.update': ['procurement.purchase_orders.update', 'procurement.purchase-orders.update', 'procurement.purchase_orders.approve', 'procurement.purchase-orders.approve', 'procurement.po.update', 'procurement.po.approve', 'finance.read', 'finance.invoices.update', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'admin.read', 'super-admin.read'],
      ...
      'procurement.invoices.read': ['procurement.invoices.read', 'procurement.invoice.read', 'procurement.vendor-invoices.read', 'procurement.vendor_invoices.read', 'procurement.procurement.read', 'procurement.read', 'finance.invoices.read', 'finance.invoice.read', 'finance.read', 'admin.read', 'super-admin.read', 'store.read', 'admin.planthead.read', 'planthead.read'],
      'procurement.vendor-invoices.read': ['procurement.vendor-invoices.read', 'procurement.vendor_invoices.read', 'procurement.invoices.read', 'procurement.invoice.read', 'procurement.procurement.read', 'procurement.read', 'finance.invoices.read', 'finance.invoice.read', 'finance.read', 'admin.read', 'super-admin.read', 'store.read', 'admin.planthead.read', 'planthead.read'],
      'procurement.vendor_invoices.read': ['procurement.vendor_invoices.read', 'procurement.vendor-invoices.read', 'procurement.invoices.read', 'procurement.invoice.read', 'procurement.procurement.read', 'procurement.read', 'finance.invoices.read', 'finance.invoice.read', 'finance.read', 'admin.read', 'super-admin.read', 'store.read', 'admin.planthead.read', 'planthead.read'],
      'procurement.vendor_invoices.create': ['procurement.vendor_invoices.create', 'procurement.vendor-invoices.create', 'procurement.invoices.create', 'procurement.invoice.create', 'procurement.procurement.create', 'procurement.create', 'finance.invoices.create', 'finance.invoice.create', 'finance.read', 'admin.read', 'super-admin.read'],
      'procurement.vendor_invoices.update': ['procurement.vendor_invoices.update', 'procurement.vendor-invoices.update', 'procurement.invoices.update', 'procurement.invoice.update', 'procurement.procurement.update', 'procurement.update', 'finance.invoices.update', 'finance.invoice.update', 'finance.read', 'admin.read', 'super-admin.read'],
      'procurement.payments.read': ['procurement.payments.read', 'procurement.payment.read', 'procurement.vendor-payments.read', 'procurement.vendor_payments.read', 'procurement.procurement.read', 'procurement.read', 'finance.payments.manage', 'finance.payment.read', 'finance.payments.read', 'finance.read', 'admin.read', 'super-admin.read', 'store.read', 'admin.planthead.read', 'planthead.read'],
      'procurement.vendor-payments.read': ['procurement.vendor-payments.read', 'procurement.vendor_payments.read', 'procurement.payments.read', 'procurement.payment.read', 'procurement.procurement.read', 'procurement.read', 'finance.payments.manage', 'finance.payment.read', 'finance.payments.read', 'finance.read', 'admin.read', 'super-admin.read', 'store.read', 'admin.planthead.read', 'planthead.read'],
      'procurement.vendor_payments.read': ['procurement.vendor_payments.read', 'procurement.vendor-payments.read', 'procurement.payments.read', 'procurement.payment.read', 'procurement.procurement.read', 'procurement.read', 'finance.payments.manage', 'finance.payment.read', 'finance.payments.read', 'finance.read', 'admin.read', 'super-admin.read', 'store.read', 'admin.planthead.read', 'planthead.read'],
      'procurement.vendor_payments.create': ['procurement.vendor_payments.create', 'procurement.vendor-payments.create', 'procurement.payments.create', 'procurement.payment.create', 'procurement.procurement.create', 'procurement.create', 'finance.payments.manage', 'finance.payment.create', 'finance.payments.create', 'finance.read', 'admin.read', 'super-admin.read'],
      'procurement.vendor_payments.update': ['procurement.vendor_payments.update', 'procurement.vendor-payments.update', 'procurement.payments.update', 'procurement.payment.update', 'procurement.procurement.update', 'procurement.update', 'finance.payments.manage', 'finance.payment.update', 'finance.payments.update', 'finance.read', 'admin.read', 'super-admin.read'],
      ...
      'sales.salesreports.read': ['sales.salesreports.read', 'sales.reports.read', 'sales.read', 'sales.orders.read', 'sales.leads.read', 'admin.read', 'super-admin.read', 'user.read'],
      'sales.reports.read': ['sales.salesreports.read', 'sales.reports.read', 'sales.read', 'sales.orders.read', 'sales.leads.read', 'admin.read', 'super-admin.read', 'user.read'],
