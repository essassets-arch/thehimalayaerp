...
export class PermissionsGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const PERMISSION_ALIASES: Record<string, string[]> = {
      ...
      'procurement.indents.read': ['procurement.indents.read', 'procurement.procurement.read', 'procurement.read', 'admin.planthead.read', 'planthead.read', 'plant-head.read', 'inventory.stock.read', 'inventory.inventory.read', 'store.read'],
      ...
      'procurement.grns.read': ['procurement.grns.read', 'procurement.grn.read', 'procurement.procurement.read', 'procurement.read', 'inventory.stock.read', 'inventory.inventory.read', 'store.read', 'admin.planthead.read', 'planthead.read'],
      'procurement.invoices.read': ['procurement.invoices.read', 'procurement.invoice.read', 'procurement.vendor-invoices.read', 'procurement.procurement.read', 'procurement.read', 'finance.invoices.read', 'finance.read', 'admin.read', 'super-admin.read'],
      'procurement.payments.read': ['procurement.payments.read', 'procurement.payment.read', 'procurement.vendor-payments.read', 'procurement.procurement.read', 'procurement.read', 'finance.payments.manage', 'finance.read', 'admin.read', 'super-admin.read'],
