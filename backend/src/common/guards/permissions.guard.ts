...
export class PermissionsGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const PERMISSION_ALIASES: Record<string, string[]> = {
      ...
      'finance.brand-analysis.read': ['finance.brand-analysis.read', 'brand-analysis.read', 'store.brand-analysis.read', 'super-admin.brand-analysis.read'],
      'store.brand-analysis.read': ['finance.brand-analysis.read', 'brand-analysis.read', 'store.brand-analysis.read', 'super-admin.brand-analysis.read'],
      'super-admin.brand-analysis.read': ['finance.brand-analysis.read', 'brand-analysis.read', 'store.brand-analysis.read', 'super-admin.brand-analysis.read'],
