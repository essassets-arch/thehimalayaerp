...
describe('After-Sales Domain — E2E Suite', () => {
  ...
  describe('1. Sales Returns & Replacements Operations', () => {
    it('lists sales return requests', async () => {
    ...
    it('lists replacement requests', async () => {
      const res = await request(app.getHttpServer())
        .get('/replacements')
        .set('Authorization', `Bearer ${adminToken}`);
      expect(res.status).toBe(200);
