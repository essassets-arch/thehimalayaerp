...
async function sendSuperSales2OrdersToPlantHead(config) {
  console.log(`\n======================================================================`);
  console.log(`SENDING ALL SUPERSALES 2 ORDERS TO PLANT HEAD: ${config.name}`);
  console.log(`Target: SuperSales 2 (supersales2@himalayaerp.com) | Orders: HCPPL/2627/0146 - 0168`);
  console.log(`======================================================================`);
  ...
  try {
    ...
    // 4. Find all SuperSales 2 orders (HCPPL/2627/0146 to HCPPL/2627/0168)
    ...
    console.log(`Found ${orders.length} orders for SuperSales 2.`);
    ...
    console.log(`\n======================================================================`);
    console.log(`SUCCESS: All ${transitionedCount} SuperSales 2 orders sent to Plant Head!`);
    console.log(`Other sales reps (Sales 1, 2, 3) remain 100% intact at Orders page!`);
    console.log(`SuperSales 1 (145 plans) and Sales 4 (10 plans) remain at Plant Head!`);
    console.log(`======================================================================\n`);
...
async function main() {
  ...
  for (const cfg of uniqueTargetDbs) {
    try {
      await sendSuperSales2OrdersToPlantHead(cfg);
      successCount++;
    } catch (err) {
