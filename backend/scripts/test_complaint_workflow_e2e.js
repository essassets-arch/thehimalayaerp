...
async function runTest() {
    ...
    const created = await prisma.customerComplaint.create({
        data: {
            ...
            status: client_1.ComplaintStatus.PLANT_HEAD_PENDING,
            ...
            statusHistory: {
                create: {
                    fromStatus: null,
                    toStatus: client_1.ComplaintStatus.PLANT_HEAD_PENDING,
    ...
    if (created.status !== client_1.ComplaintStatus.PLANT_HEAD_PENDING) {
    ...
    const approved = await prisma.customerComplaint.update({
        where: { id: created.id },
        data: {
            status: client_1.ComplaintStatus.DISPATCH_PENDING,
            ...
            statusHistory: {
                create: {
                    fromStatus: client_1.ComplaintStatus.PLANT_HEAD_PENDING,
                    toStatus: client_1.ComplaintStatus.DISPATCH_PENDING,
    ...
    if (approved.status !== client_1.ComplaintStatus.DISPATCH_PENDING) {
    ...
    const dispatchCompleted = await prisma.customerComplaint.update({
        where: { id: created.id },
        data: {
            status: client_1.ComplaintStatus.FINANCE_PENDING,
            ...
            statusHistory: {
                create: {
                    fromStatus: client_1.ComplaintStatus.DISPATCH_PENDING,
                    toStatus: client_1.ComplaintStatus.FINANCE_PENDING,
    ...
    if (dispatchCompleted.status !== client_1.ComplaintStatus.FINANCE_PENDING) {
    ...
    const resolved = await prisma.$transaction(async (tx) => {
        ...
        await tx.complaintStatusHistory.create({
            data: {
                complaintId: created.id,
                fromStatus: client_1.ComplaintStatus.FINANCE_PENDING,
                toStatus: client_1.ComplaintStatus.RESOLVED,
