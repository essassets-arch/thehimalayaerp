...
ADD COLUMN IF NOT EXISTS "totalFrames" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN IF NOT EXISTS "totalSets" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN IF NOT EXISTS "totalCoverWeight" DECIMAL(14,3) NOT NULL DEFAULT 0,
ADD COLUMN IF NOT EXISTS "totalFrameWeight" DECIMAL(14,3) NOT NULL DEFAULT 0,
ADD COLUMN IF NOT EXISTS "totalWeight" DECIMAL(14,3) NOT NULL DEFAULT 0,
