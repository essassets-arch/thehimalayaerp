...
// ─── 217 Master Raw Inventory Items Seed (Authoritative CSV) ───────────────────

const masterRawMaterialsSeedData = [
  {
    "code": "HM107",
...
async function main() {
  ...
  const accountsToSeed = [
    ...
    { email: 'abbas.b@himalayaerp.com', rawPassword: 'dataAnalyst#2101', name: 'Abbas B', firstName: 'Abbas', lastName: 'B', roleCode: 'BACK_OFFICE', deptName: 'Super Admin Department', jobTitle: 'Data Analyst & Back Office Lead' },
