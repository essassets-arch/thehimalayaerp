...
// Fixed nested wrapper logic to support proper image aspect scaling and layout
function AvatarImage({ className, ...props }: React.ComponentProps<typeof AvatarPrimitive.Image>) {
  return (
    <div className={cn('relative overflow-hidden rounded-full w-full h-full', className)}>
