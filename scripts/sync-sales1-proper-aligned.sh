#!/usr/bin/env bash
# ==============================================================================
# HIMALAYA ERP — SYNC SALES 1 (sales1@himalayaerp.com) COMPLETE PIPELINE (LEAD -> QUOTE -> ORDER)
# ==============================================================================
set -Eeuo pipefail
...
echo "========================================================================"
echo "⚡ SYNCING SALES 1 (sales1@himalayaerp.com) PIPELINE ON VPS / DOCKER"
echo "========================================================================"
...
if [ -f "jesal.csv" ]; then
    ...
    CSV_S1="backend/scripts/jesal.csv"
elif [ -f "scripts/jesal.csv" ]; then
    CSV_S1="scripts/jesal.csv"
fi
...
echo "========================================================================"
echo "✅ Sales 1 (Lead -> Quote -> Order) Completed!"
echo "========================================================================"
