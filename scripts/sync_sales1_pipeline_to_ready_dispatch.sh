...
echo "========================================================================"
echo "🚀 SYNC SALES 1 (JP) TO READY FOR DISPATCH"
echo "========================================================================"
...
docker cp backend/scripts/sync_sales1_pipeline_to_ready_dispatch.js himalaya-backend:/app/scripts/
docker cp backend/scripts/sales1_leads_data.json himalaya-backend:/app/scripts/
docker cp backend/scripts/JP_data_sales1.csv himalaya-backend:/app/scripts/
...
docker exec himalaya-backend node scripts/sync_sales1_pipeline_to_ready_dispatch.js
...
echo "========================================================================"
echo "🎉 SUCCESS: All 49 Orders & 100 Work Orders for Sales 1 are READY FOR DISPATCH!"
