...
"[project]/store/domains/sales/salesSelectors.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$sales$2f$salesCalculations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/domains/sales/salesCalculations.ts [app-ssr] (ecmascript)");
;
;
...
/** Samples enriched with testing countdown for Sales/Admin panels */ const _selectEnrichedSamples = (store)=>getSales(store).samples.map((s)=>({
            ...s,
            testingRemainingDays: (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$sales$2f$salesCalculations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSampleRemainingDays"])(s)
        }));
// ════════════════════════════════════════════════════════════════════════════
//  QUOTATION SELECTORS
// ════════════════════════════════════════════════════════════════════════════
 ...
 */ const _selectPlantHeadIncomingOrders = (store)=>{
    ...
    return orders.filter((o)=>o.sentToPlantHead === true || (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$shared$2f$workflowUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeStatus"])(o.workflowStatus) === 'SENT_TO_PLANT_HEAD' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$shared$2f$workflowUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeStatus"])(o.plantHeadStatus) === 'PENDING' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$shared$2f$workflowUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeStatus"])(o.status) === 'SENT_TO_PLANT_HEAD' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$shared$2f$workflowUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeStatus"])(o.planningStatus) === 'PENDING_ACCEPTANCE').filter((o)=>![
            'ACCEPTED',
            'REJECTED'
        ].includes((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$shared$2f$workflowUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeStatus"])(o.plantHeadStatus))).map(toPlantHeadSafeView);
};
/**
...
const canRecordPayment = (order, confirmations)=>order.commercialStatus !== 'ORDER_CANCELLED' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$sales$2f$salesCalculations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculatePendingAmount"])(order, confirmations) > 0;
const canRequestReplacement = (order, replacements, returns)=>{
    ...
    for (const item of order.items){
        totalAvailable += (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$domains$2f$sales$2f$salesCalculations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAvailableAfterSalesQuantity"])(item.id, item.quantity, replacements, returns);
    }
...
/** Plant Head view: no payment, no pricing — operational info only */ function toPlantHeadSafeView(order) {
    ...
    return {
        ...
        products: order.products || (safeItems.length > 0 ? safeItems.map((i)=>`${i?.productName || i?.name || 'Item'} (${i?.quantity || 1} Qty)`).join(', ') : 'Items'),
...
/** Production view: operational info only */ function toProductionSafeView(order) {
    const safeItems = Array.isArray(order.items) ? order.items : [];
    const productStr = order.products || (safeItems.length > 0 ? safeItems.map((i)=>i?.productName || i?.name || 'Item').join(', ') : 'Custom Engineered Product');
    return {
        ...order,
        id: order.id,
        orderNo: order.orderNo || order.id,
...
"[project]/store/materialFlow.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/production.ts [app-ssr] (ecmascript)");
;
;
;
const requests = (state)=>Array.isArray(state?.production?.materialRequests) ? state.production.materialRequests : [];
const selectMaterialRequests = requests;
const selectPlantHeadPendingRequests = (state)=>requests(state).filter((request)=>request.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PENDING_PLANT_HEAD_APPROVAL);
const selectPlantHeadHistoryRequests = (state)=>requests(state).filter((request)=>request.status !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PENDING_PLANT_HEAD_APPROVAL);
const selectStoreApprovedRequests = (state)=>requests(state).filter((request)=>request.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PLANT_HEAD_APPROVED);
const selectStoreRequestHistory = (state)=>requests(state).filter((request)=>request.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].STORE_REJECTED);
const selectStoreReleaseRequests = (state)=>requests(state).filter((request)=>request.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].STORE_APPROVED);
const selectProductionStoreReleases = (state)=>requests(state).filter((request)=>request.department === 'Production' && request.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].ISSUED);
...
const materialMatches = (inventoryItem, requestItem)=>[
        ...
        inventoryItem?.code
    ].filter(Boolean).includes(requestItem?.materialId) || String(inventoryItem?.material || inventoryItem?.name || '').toLowerCase() === String(requestItem?.materialName || requestItem?.material || '').toLowerCase();
const submitMaterialRequest = (data)=>{
    const now = new Date().toISOString();
    const id = data.id || __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().generateEntityId('materialRequest');
    const request = {
        ...data,
        id,
        requestNo: id,
        ...
        status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PENDING_PLANT_HEAD_APPROVAL,
...
const approveMaterialRequest = (requestId, approvedItems, approvedBy = 'Plant Head')=>{
    ...
    commit((state)=>({
            ...
            production: {
                ...
                materialRequests: requests(state).map((request)=>request.id === requestId ? {
                        ...request,
                        status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PLANT_HEAD_APPROVED,
                        approvedBy,
                        approvedAt,
                        items: request.items.map((item)=>{
                            ...
                            return {
                                ...item,
                                approvedQty: Number(approved?.approvedQty ?? item.requestedQty ?? 0)
                            };
                        })
                    } : request)
            }
...
const rejectMaterialRequest = (requestId, approvedBy = 'Plant Head')=>{
    const approvedAt = new Date().toISOString();
    commit((state)=>({
            ...state,
            production: {
                ...
                materialRequests: requests(state).map((request)=>request.id === requestId ? {
                        ...request,
                        status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PLANT_HEAD_REJECTED,
                        approvedBy,
                        approvedAt
                    } : request)
            }
...
const approveStoreMaterialRequest = (requestId, actorName = 'Store')=>{
    const store = __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState();
    const state = store.state || {};
    const request = requests(state).find((entry)=>entry.id === requestId);
    if (!request) throw new Error('Material request not found.');
    if (request.status !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PLANT_HEAD_APPROVED) {
    ...
    store.setState({
        ...
        production: {
            ...
            materialRequests: requests(state).map((entry)=>entry.id === requestId ? {
                    ...entry,
                    status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].STORE_APPROVED,
...
const rejectStoreMaterialRequest = (requestId, remarks, actorName = 'Store')=>{
    ...
    commit((state)=>({
            ...
            production: {
                ...state.production || {},
                materialRequests: requests(state).map((request)=>request.id === requestId && request.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].PLANT_HEAD_APPROVED ? {
                        ...request,
                        status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].STORE_REJECTED,
...
const issueCompleteOrderMaterials = (orderId, actorName = 'Store')=>{
    const store = __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState();
    const state = store.state || {};
    ...
    if (orderRequests.some((request)=>request.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].ISSUED)) {
        throw new Error('This order has already been issued.');
    }
    if (orderRequests.some((request)=>request.status !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].STORE_APPROVED)) {
    ...
    const sequence = String((state.production?.stockLedgerEntries || []).filter((entry)=>entry.orderId === orderId).length + 1).padStart(3, '0');
    ...
    store.setState({
        ...
        production: {
            ...
            materialRequests: requests(state).map((request)=>requestIds.has(request.id) ? {
                    ...request,
                    status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$production$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REQUEST_STATUS"].ISSUED,
                    issuedBy: actorName,
                    issuedAt,
                    issueReference,
                    items: request.items.map((item)=>({
...
"[project]/store/procurementSelectors.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getStoreState() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().state;
}
...
"[project]/store/procurementActions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/erpStore.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/procurement.ts [app-ssr] (ecmascript)");
;
;
// ---------------------------------------------------------
// HELPERS
...
function updateStoreState(newState) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().setState(newState);
}
...
function generateNotification(role, title, message) {
    ...
    notifications.push({
        id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createId"])('NOTIF'),
        role,
        title,
        message,
        read: false,
...
function createMaterialIndent(data, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().createMaterialIndent(data);
}
function returnIndentForCorrection(indentId, remarks, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().returnMaterialIndent(indentId, remarks);
}
function approveMaterialIndent(indentId, approvedItems, remarks, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().approveMaterialIndent(indentId, approvedItems, remarks);
}
function createPurchaseOrder(indentId, poData, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().createPurchaseOrderFromIndent(indentId, poData, actorName);
}
function submitPurchaseOrder(poId, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().submitPurchaseOrder(poId, actorName);
}
function approvePurchaseOrder(poId, remarks, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().approvePurchaseOrder(poId, remarks, actorName);
}
function issuePurchaseOrder(poId, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().issuePurchaseOrder(poId, undefined, actorName);
}
function createGRN(poId, grnData, actorName) {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().createGoodsReceipt(poId, grnData, actorName);
}
function approveGoodsReceiptNote(grnId, remarks = 'Approved by Finance Audit', actorName = 'Finance') {
    __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$erpStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useERPStore"].getState().approveGoodsReceiptNote(grnId, remarks, actorName);
}
...
function submitMaterialRejection(data, actorName) {
    ...
    const newRej = {
        ...data,
        id: data.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createId"])('REJ'),
        rejectionNumber: data.rejectionNumber || (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createHumanNo"])('REJ'),
        status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].MATERIAL_REJECTION_SUBMITTED,
    ...
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', newRej.id, 'SUBMIT', null, newRej.status, actorName, 'Store');
    updateStoreState({
        ...getStoreState(),
        procurement: {
...
function approveVendorReplacement({ rejectionId, approvedReplacementQty, expectedDeliveryDate, vendorAcknowledgementNumber, vendorRemarks, financeRemarks, defectiveMaterialDisposition, documentIds = [], actor }) {
    const state = getStoreState();
    const rejections = safeClone(state.materialRejections || []);
    ...
    rej.status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].REPLACEMENT_EXPECTED;
    ...
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'APPROVE_REPLACEMENT', oldStatus, rej.status, actor, 'Finance');
    updateStoreState({
        ...state,
...
function createReplacementGRN(rejectionId, grnData, actorName) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertTransition"])('MATERIAL_REJECTION', rej.status, [
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].REPLACEMENT_EXPECTED,
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].PARTIALLY_RESOLVED
    ...
    const newGRN = {
        ...grnData,
        id: grnData.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createId"])('GRN-REP'),
        grnNumber: grnData.grnNumber || (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createHumanNo"])('GRN-REP'),
        grnType: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GRN_TYPE"].REPLACEMENT,
        poId: rej.poId,
        originalGrnId: rej.grnId,
        materialRejectionId: rej.id,
        status: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GRN_STATUS"].SUBMITTED_FOR_FINANCE_AUDIT,
        commercialTreatment: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMMERCIAL_TREATMENT"].ZERO_VALUE_REPLACEMENT,
    ...
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('GRN', newGRN.id, 'CREATE_REPLACEMENT_GRN', null, newGRN.status, actorName, 'Store');
    updateStoreState({
        ...state,
        procurement: {
            ...state.procurement || {},
...
function canClosePurchaseOrder(poId) {
    const state = getStoreState();
    const po = (state.procurement?.purchaseOrders || []).find((p)=>p.id === poId);
    if (!po) return {
        allowed: false,
        blockers: [
            'PO not found'
    ...
    const grns = (state.procurement?.goodsReceiptNotes || []).filter((g)=>g.poId === poId);
    grns.forEach((g)=>{
        if (g.status !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GRN_STATUS"].FINANCE_APPROVED && g.status !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GRN_STATUS"].FINANCE_REJECTED && g.status !== 'FINANCE_AUDIT_APPROVED') {
    ...
    rejections.forEach((r)=>{
        if (r.status !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].CLOSED) {
...
function closePurchaseOrder(poId, remarks, actorName) {
    ...
    pos[idx].status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PO_STATUS"].PO_CLOSED;
    pos[idx].closureRemarks = remarks;
    pos[idx].updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('PURCHASE_ORDER', poId, 'CLOSE', oldStatus, pos[idx].status, actorName, 'Finance', remarks);
    updateStoreState({
        ...state,
        procurement: {
            ...state.procurement || {},
...
function disposeRejectedStock(rejectionId, quantity, disposition, actorName) {
    ...
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'DISPOSE_ORIGINAL_STOCK', rej.status, rej.status, actorName, 'Finance', disposition);
    updateStoreState({
        ...getStoreState(),
        materialRejections: rejections,
        procurementAuditLogs: [
...
function rejectStoreRejection(rejectionId, remarks, actorName, idempotencyKey) {
    ...
    if (idempotencyKey && logs.some((l)=>l.metadata?.idempotencyKey === idempotencyKey)) return;
    const idx = rejections.findIndex((r)=>r.id === rejectionId);
    if (idx === -1) throw new Error("Rejection not found");
    const rej = rejections[idx];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertTransition"])('MATERIAL_REJECTION', rej.status, [
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].MATERIAL_REJECTION_SUBMITTED,
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].FINANCE_VENDOR_DISCUSSION
    ...
    if (item) {
        ...
        item.history.push({
            ...
            remarks: `Store Rejection ${rej.rejectionNumber} Rejected by Finance`
        });
        updateStoreState({
            ...state,
            rawInventory
    ...
    const oldStatus = rej.status;
    rej.status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].REJECTED_BY_FINANCE;
    ...
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'REJECT_STORE_REJECTION', oldStatus, rej.status, actorName, 'Finance', remarks, {}, [], {
        idempotencyKey
    });
    updateStoreState({
        ...getStoreState(),
...
function raiseVendorDispute(rejectionId, remarks, actorName, idempotencyKey) {
    const state = getStoreState();
    const rejections = safeClone(state.materialRejections || []);
    if (idempotencyKey && (state.procurementAuditLogs || []).some((l)=>l.metadata?.idempotencyKey === idempotencyKey)) return;
    const idx = rejections.findIndex((r)=>r.id === rejectionId);
    if (idx === -1) throw new Error("Rejection not found");
    const rej = rejections[idx];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertTransition"])('MATERIAL_REJECTION', rej.status, [
    ...
    const oldStatus = rej.status;
    rej.status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].VENDOR_DISPUTE;
    rej.financeRemarks = remarks;
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'RAISE_VENDOR_DISPUTE', oldStatus, rej.status, actorName, 'Finance', remarks, {}, [], {
        idempotencyKey
    });
    updateStoreState({
        ...state,
...
function processNoReplacement(rejectionId, resolutionType, remarks, actorName, idempotencyKey) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertTransition"])('MATERIAL_REJECTION', rej.status, [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].FINANCE_VENDOR_DISCUSSION,
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].PARTIALLY_RESOLVED,
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].VENDOR_DISPUTE
    ], 'Process No Replacement');
    const oldStatus = rej.status;
    rej.status = resolutionType === 'CREDIT_NOTE' ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].CREDIT_NOTE_PENDING : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].NO_REPLACEMENT;
    rej.financeRemarks = remarks;
    rej.expectedResolutionType = resolutionType;
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'PROCESS_NO_REPLACEMENT', oldStatus, rej.status, actorName, 'Finance', remarks, {}, [], {
        idempotencyKey,
        resolutionType
    });
    updateStoreState({
...
function recordCommercialAdjustment(rejectionId, settledQty, adjustmentDetails, actorName, idempotencyKey) {
    ...
    if (rej.remainingResolutionQty <= 0) {
        rej.status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].COMMERCIAL_ADJUSTMENT_COMPLETED;
    }
    rej.financeRemarks = adjustmentDetails;
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'RECORD_COMMERCIAL_ADJUSTMENT', oldStatus, rej.status, actorName, 'Finance', adjustmentDetails, {}, [], {
        idempotencyKey
    });
    updateStoreState({
        ...state,
...
function processWriteOff(rejectionId, writeOffQty, approvalMetadata, actorName, idempotencyKey) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["assertTransition"])('MATERIAL_REJECTION', rej.status, [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].PARTIALLY_RESOLVED,
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].VENDOR_DISPUTE,
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].CREDIT_NOTE_PENDING,
        __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].NO_REPLACEMENT
    ], 'Process Write Off');
    ...
    rej.remainingResolutionQty = rej.rejectedQty - (rej.cumulativeReplacementAcceptedQty || 0) - rej.commerciallySettledQty;
    rej.status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].WRITE_OFF_APPROVED;
    rej.financeRemarks = approvalMetadata.remarks || "Write-off approved";
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'PROCESS_WRITE_OFF', oldStatus, rej.status, actorName, 'Finance', rej.financeRemarks, {}, [], {
        idempotencyKey,
        approvalMetadata
    });
    updateStoreState({
...
function canCloseMaterialRejection(rejectionId) {
    ...
    const blockers = [];
    if (rej.status === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].CLOSED) {
    ...
    if (!rej.originalStockDisposition && rej.status !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].REJECTED_BY_FINANCE) {
...
function closeMaterialRejection(rejectionId, actorName, idempotencyKey) {
    ...
    const rej = rejections[idx];
    const oldStatus = rej.status;
    rej.status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MATERIAL_REJECTION_STATUS"].CLOSED;
    rej.updatedAt = new Date().toISOString();
    const audit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$procurement$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createProcurementAuditEntry"])('MATERIAL_REJECTION', rej.id, 'CLOSE', oldStatus, rej.status, actorName, 'Finance', '', {}, [], {
        idempotencyKey
    });
    updateStoreState({
        ...state,
...
"[project]/services/production.service.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shared/constants.js [app-ssr] (ecmascript)");
;
;
const normalizeMaterialLines = (request = {})=>{
    ...
    return source.map((material)=>({
            ...
            quantityRequested: Number(material.quantityRequested ?? material.requestedQty ?? material.quantity ?? material.qty ?? 0),
            quantityApproved: Number(material.quantityApproved ?? material.approvedQty ?? material.quantityRequested ?? material.requestedQty ?? material.quantity ?? material.qty ?? 0)
...
const productionService = {
    planOrder: async (state, order, targetDate, priority, dispatch, currentUser)=>{
        const payload = {
            ...
            status: __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STATUS"].PLANNED,
            notes: `Plan generated from Sales Order ${order.orderNo}`
        };
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/production/plans', payload);
        return {
            success: true,
            planId: res.planId
        };
    ...
    createWorkOrder: async (state, order, dispatch, currentUser)=>{
        ...
        if (workOrderIds.length > 0) {
            ...
            for (const woId of workOrderIds){
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/workflow/transition', {
                    entity: 'work_order',
                    entityId: woId,
    ...
    raiseMaterialRequest: async (state, workOrder, materials, dispatch, currentUser)=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/production/material-requests', payload);
        return {
            success: true,
            requestId: res.data?.requestId || res.requestId
        };
    },
    approveMaterialRequest: async (state, request, targetQtyOverrides, statusOrIsApproved, dispatch, currentUser)=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].patch(`/production/material-requests/${mrDbId}/status`, payload);
        return {
            success: true,
            data: res
        };
    ...
    issueMaterial: async (state, request, department, dispatch, currentUser)=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post(`/production/material-requests/${mrDbId}/issue`, payload);
        return {
            success: true,
            data: res
        };
    ...
    updateProductionProgress: async (state, workOrder, progress, stage, dispatch, currentUser)=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].put(`/production/work-orders/${woDbId}`, payload);
        return {
            success: true,
            data: res
        };
    ...
    completeProduction: async (state, workOrder, dispatch, currentUser, payload = {})=>{
        const woDbId = workOrder.dbId || workOrder.id;
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].patch(`/production/work-orders/${woDbId}/complete`, payload);
        return {
            success: true,
            data: res
        };
    ...
    submitQCInspection: async (state, order, workOrder, qcResults, isApproved, dispatch, currentUser)=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/production/qc', payload);
    ...
    getQCInspections: async (filters = {})=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/production/qc${suffix}`);
        return res.data || res;
    },
    sendToReproduction: async (state, workOrder, dispatch, currentUser)=>{
        ...
        const payload = {
            quantity_produced: 0,
            status: __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STATUS"].REWORK,
            notes: JSON.stringify(notesObj)
        };
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].put(`/production/work-orders/${woDbId}`, payload);
        return {
    ...
    getDashboardStats: async ()=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get('/production/dashboard-stats');
        return res.data || res;
    },
    getProductionEntries: async (filters = {})=>{
        const queryParams = new URLSearchParams(filters).toString();
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/production/production?${queryParams}`);
        return res.data || res;
    },
    createProductionEntry: async (payload)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/production/production', payload);
        return res.data || res;
    },
    getTestingEntries: async (filters = {})=>{
        const queryParams = new URLSearchParams(filters).toString();
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/production/testing?${queryParams}`);
        return res.data || res;
    },
    getTestingEntryById: async (id)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/production/testing/${id}`);
        return res.data || res;
    },
    updateTestingEntry: async (id, payload)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].put(`/production/testing/${id}`, payload);
        return res.data || res;
    },
    approveTestingEntry: async (id, payload)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post(`/production/testing/${id}/approve`, payload);
        return res.data || res;
    },
    deleteTestingEntry: async (id)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].delete(`/production/testing/${id}`);
        return res.data || res;
    },
    getRejectionEntries: async (filters = {})=>{
        const queryParams = new URLSearchParams(filters).toString();
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/production/rejection?${queryParams}`);
        return res.data || res;
    },
    createRejectionEntry: async (payload)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/production/rejection', payload);
        return res.data || res;
    },
    executeRejectionAction: async (id, payload)=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post(`/production/rejection/${id}/action`, payload);
        return res.data || res;
    }
};
}),
"[project]/services/product.service.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const productService = {
   ...
   */ addProduct: async (productData)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/purchase/products', productData);
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$engine$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERPError"])(err.message, 'API_ERROR');
        }
    },
    /**
   ...
   */ updateProduct: async (productId, productData)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].put(`/purchase/products/${productId}`, productData);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$engine$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERPSuccess"])(result);
        } catch (err) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$engine$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERPError"])(err.message, 'API_ERROR');
        }
   ...
   */ deleteProduct: async (productId)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].delete(`/purchase/products/${productId}`);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$engine$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERPSuccess"])(result);
        } catch (err) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$engine$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERPError"])(err.message, 'API_ERROR');
        }
   ...
   */ deleteProducts: async (productIds)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/purchase/products/bulk-delete', {
                ids: productIds
            });
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$engine$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERPSuccess"])(result);
        } catch (err) {
...
"[project]/constants/production.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/(dashboard)/plant-head/[[...slug]]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$plant$2d$head$2f$pages$2f$PlantHeadPortal$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/plant-head/pages/PlantHeadPortal.jsx [app-ssr] (ecmascript)");
'use client';
;
;
function Page() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$plant$2d$head$2f$pages$2f$PlantHeadPortal$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/app/(dashboard)/plant-head/[[...slug]]/page.tsx",
        lineNumber: 6,
        columnNumber: 10
    }, this);
}
...
//# sourceMappingURL=_ed4e7719._.js.map