...
"[project]/app/(dashboard)/plant-head/recruitment-request/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RecruitmentRequestPage() {
    ...
    const [vacancies, setVacancies] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('1');
    ...
    const handleSubmit = (e)=>{
        ...
        if (!role.trim()) return;
        const newReq = {
            id: "RR-".concat(Date.now().toString().slice(-3)),
            role,
            department,
...
_s(RecruitmentRequestPage, "0o7KsCyFJvwSOa+RCw47YV8S4SQ=");
_c = RecruitmentRequestPage;
var _c;
__turbopack_context__.k.register(_c, "RecruitmentRequestPage");
...
//# sourceMappingURL=_958ed777._.js.map