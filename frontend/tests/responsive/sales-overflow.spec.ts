...
const salesRoutes = [
  ...
  '/supersales/orders',
  '/supersales/customers',
  '/supersales/samples',
  '/supersales/payment-followup',
  '/supersales/payment-history',
  '/supersales/customer-complaints',
];

test.describe('Sales & SuperSales Viewport Overflow Suite', () => {
  for (const vp of viewports) {
    test(`Verify 0 horizontal page overflow at ${vp.name}`, async ({ page }) => {
