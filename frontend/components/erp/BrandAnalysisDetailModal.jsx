      ...
      >
        ...
        <div className="brand-request-view-body">
                  ...
                  <>
                    {isPdf ? (
                      <div style={{ padding: '24px', background: '#f1f5f9', borderRadius: '12px', color: '#0284c7', textAlign: 'center', width: '100%', border: '1px solid #cbd5e1' }}>
                        ...
                        <a href={finalUrl} target="_blank" rel="noreferrer" className="brand-request-open-image">
                          Open PDF Document
                        </a>
                      </div>
                    ) : (
          ...
          {request.status === 'SUPER_ADMIN_REJECTED' && (
            <section className="brand-request-section">
              <div className="brand-request-section-heading">
                <h3 className="text-red-600">Rejection Reason</h3>
              </div>
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <p className="text-red-900 text-sm font-semibold">{request.rejectionReason}</p>
              </div>
            </section>
          )}
            ...
            <section className="brand-request-section">
              ...
              <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                  ...
                  <div>
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-bold ${
                      request.recommendation === 'RECOMMENDED' ? 'bg-emerald-200 text-emerald-900' :
                      request.recommendation === 'NOT_RECOMMENDED' ? 'bg-red-200 text-red-900' :
                ...
                <div className="pt-4 border-t border-emerald-200">
                  ...
                  <p className="text-slate-800 text-sm font-semibold">{request.analysisResult}</p>
                </div>
              </div>
            </section>
          )}
          ...
          {isFinance && request.status === 'SUPER_ADMIN_APPROVED' && (
            <section className="brand-request-section">
              ...
              <div className="flex justify-between items-center mt-4">
                <p className="text-slate-600 text-sm font-semibold">Click the button to mark this request as currently under analysis.</p>
                <button 
                  disabled={isSubmitting}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white border border-slate-300 focus:border-sky-500 focus:outline-none rounded-lg p-3 text-slate-900 font-semibold"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-white border border-slate-300 focus:border-sky-500 focus:outline-none rounded-lg p-3 pl-8 text-slate-900 font-semibold"
                      placeholder="0.00"
                    />
                  </div>
                </div>
