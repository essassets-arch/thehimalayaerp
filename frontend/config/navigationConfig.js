...
export const navigationConfig = {
  ...
  'Dispatch': [
    ...
    { id: 'finished-goods', label: 'Finished Goods', icon: PackageCheck, path: '/dispatch/finished-goods', group: 'Logistics' },
    {
      ...
      group: 'Logistics',
      subItems: [
        { id: 'pending-dispatch', label: 'Pending Dispatch Queue', path: '/dispatch/orders' },
        { id: 'in-transit', label: 'In Transit Queue', path: '/dispatch/in-transit' },
        { id: 'delivered', label: 'Out for Delivery / POD', path: '/dispatch/delivery' },
  ...
  'Super Admin': [
    ...
    { id: 'all-stock', label: 'All Stock', icon: Boxes, path: '/super-admin/all-stock' },
