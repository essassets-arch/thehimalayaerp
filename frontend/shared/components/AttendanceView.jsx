                  ...
                  {activePreview?.punchInSelfieUrl || activePreview?.punchOutSelfieUrl ? (
                    <div style={{ display: 'flex', gap: '8px', width: '100%', height: '100%', flex: 1 }}>
                      {activePreview?.punchInSelfieUrl ? (
                        <div style={{ flex: 1, position: 'relative', height: '100%', borderRadius: '8px', overflow: 'hidden' }}>
                          <SecureImage src={activePreview.punchInSelfieUrl} alt="Punch In Selfie" style={{ width: '100%', height: '100%', objectFit: 'cover' }} fallbackText="Punch In" allowZoom={true} />
                      ...
                      {activePreview?.punchOutSelfieUrl ? (
                        <div style={{ flex: 1, position: 'relative', height: '100%', borderRadius: '8px', overflow: 'hidden' }}>
                          <SecureImage src={activePreview.punchOutSelfieUrl} alt="Punch Out Selfie" style={{ width: '100%', height: '100%', objectFit: 'cover' }} fallbackText="Punch Out" allowZoom={true} />
                    ...
                    activePreview?.selfieUrl ? (
                      <div style={{ flex: 1, width: '100%', height: '100%', position: 'relative' }}>
                        <SecureImage src={activePreview.selfieUrl} alt="Webcam Capture" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px' }} fallbackText="Biometric Capture" allowZoom={true} />
                      </div>
                    ) : (
