...
const ChartCard = ({ title, subtitle, children }) => {
  return (
    <div className="app-card" style={{ display: 'flex', flexDirection: 'column', gap: '16px', height: '100%', minHeight: '340px', width: '100%', minWidth: 0 }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', minWidth: 0, minHeight: 0 }}>
        {children}
      </div>
    </div>
  );
