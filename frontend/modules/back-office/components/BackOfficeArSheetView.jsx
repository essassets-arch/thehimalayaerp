...
export default function BackOfficeArSheetView({
  ...
  return (
    <div style={{ padding: isMobile ? '12px' : '24px', maxWidth: '1700px', margin: '0 auto', color: '#1e293b', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      {/* Toast Notification */}
      {successToast && (
        <div style={{
          position: 'fixed',
      ...
      <div style={{
        ...
        <div style={{ background: '#fff', padding: isMobile ? '12px' : '16px 20px', borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ fontSize: '10px', color: '#94a3b8', marginTop: '2px' }}>Filtered accounts</div>
        </div>
      ...
      {/* Error state */}
      {error && (
        <div style={{ padding: '14px 18px', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: '10px', color: '#991b1b', marginBottom: '18px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          <AlertCircle size={16} />
      ...
      {activeView === 'list' ? (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                      <span style={{ fontSize: '11px', fontWeight: '700', padding: '2px 7px', borderRadius: '6px', background: '#f1f5f9', color: '#475569' }}>
                        #{item.srNo}
                      </span>
                      <span style={{ fontSize: '15px', fontWeight: '800', color: brandColor }}>
                        {item.invoiceNo}
                      </span>
                      <span style={{ fontSize: '11px', fontWeight: '600', padding: '2px 7px', borderRadius: '6px', background: brandBg, color: brandColor }}>
                        {item.quarter}
                      </span>
                    </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap', marginBottom: '12px' }}>
                    ...
                    <span style={{ padding: '2px 8px', borderRadius: '6px', fontSize: '11px', fontWeight: '600', background: '#e0f2fe', color: '#0369a1' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                    <div style={{ background: '#f8fafc', padding: '8px 10px', borderRadius: '6px' }}>
                      <div style={{ fontSize: '10px', fontWeight: '600', color: '#64748b' }}>INVOICE AMOUNT</div>
                    ...
                    <div style={{ background: '#f8fafc', padding: '8px 10px', borderRadius: '6px' }}>
                      <div style={{ fontSize: '10px', fontWeight: '600', color: '#64748b' }}>OUTSTANDING</div>
                      <div style={{ fontSize: '14px', fontWeight: '800', color: Number(item.outstanding) > 0 ? '#dc2626' : '#16a34a' }}>
                        {formatCurrency(item.outstanding)}
                      </div>
                      <div style={{ fontSize: '10px', color: '#94a3b8' }}>Rcvd: {formatCurrency(item.amtRcvd)}</div>
                    </div>
                  </div>
                </div>
              );
        ...
        <div style={{ background: '#fff', borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', overflow: 'hidden', marginBottom: '20px' }}>
          <div style={{ overflowX: 'auto', maxHeight: '720px', WebkitOverflowScrolling: 'touch' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px', textAlign: 'left', whiteSpace: 'nowrap' }}>
              <thead style={{ position: 'sticky', top: 0, background: '#f8fafc', zIndex: 10, borderBottom: '2px solid #cbd5e1' }}>
                <tr>
                  <th style={{ padding: '12px 14px', fontWeight: '700', color: '#334155', width: '80px', borderRight: '1px solid #e2e8f0', textAlign: 'center' }}>
                    Action
                  </th>
                  {AR_COLUMNS.map((col) => (
                    <th
                  ...
                  data.map((item, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* 2. Invoice No */}
                        <td style={{ padding: '10px 14px', fontWeight: '700', color: brandColor, borderRight: '1px solid #f1f5f9' }}>
                          {item.invoiceNo}
                        </td>
                        ...
                        {/* 21. Quarter */}
                        <td style={{ padding: '10px 14px', textAlign: 'center', fontWeight: '600', color: brandColor }}>
                          {item.quarter}
                        </td>
                      </tr>
                    );
      ...
      {/* 6. Data Entry Modal (Add / Edit) - All 21 Columns */}
      {modalOpen && (
        <div style={{
          position: 'fixed',
          inset: 0,
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{ padding: '6px', background: brandBg, borderRadius: '6px', color: brandColor }}>
                  <FileSpreadsheet size={18} />
                </div>
                <div>
                  <h3 style={{ fontSize: isMobile ? '16px' : '18px', fontWeight: '700', color: '#0f172a', margin: 0 }}>
                    {modalMode === 'create' ? `Add New Entry to ${sheetTitle}` : `Edit Invoice: ${formData.invoiceNumber}`}
                  </h3>
                  <p style={{ fontSize: '11px', color: '#64748b', margin: '2px 0 0' }}>
                    All 21 columns can be directly entered or auto-calculated with the button on the right.
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleSaveForm}>
              ...
              <div style={{ marginBottom: '18px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fit, minmax(200px, 1fr))', gap: '14px' }}>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: '#334155', marginBottom: '4px' }}>
                      Basic Amount (W/O Cartage and GST) *
                    </label>
                    <input
                      type="number"
                      step="0.01"
              ...
              <div style={{
                ...
                >
                  <Save size={15} />
                  {saving ? 'Saving...' : modalMode === 'create' ? 'Create & Add to Sheet' : 'Update Entry'}
                </button>
              </div>
            </form>
          </div>
