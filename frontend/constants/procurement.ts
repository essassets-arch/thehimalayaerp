...
export const PO_STATUS = {
  ...
  PENDING_PLANT_HEAD_PURCHASE_APPROVAL: 'PENDING_PLANT_HEAD_PURCHASE_APPROVAL',
  PLANT_HEAD_PURCHASE_APPROVED: 'PLANT_HEAD_PURCHASE_APPROVED',
  PLANT_HEAD_PURCHASE_REJECTED: 'PLANT_HEAD_PURCHASE_REJECTED',
